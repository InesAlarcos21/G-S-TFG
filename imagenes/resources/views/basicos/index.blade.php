...
<div class="container shadow  mb-5 ">
    <br>
    <h3 class="w3-large mt-3" style="font-size: 22px; text-align: center; margin-right: 5px;  ">
    ...
    <form  method="POST" action="{{route('adminUser.update',['usuario' =>$usuario->id])}}" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-group ml-3 mb-5 mr-3 mt-3">
            <label for="telefono" class="mt-4">Añada tu numero de telefono</label>
        ...
        <table class=" mt-5 table  table-responsive-sm ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="btn-dark justify-content-center text-white " style="text-align: center; border-radius: 5.5px;" >
