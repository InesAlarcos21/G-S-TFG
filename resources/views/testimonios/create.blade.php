...
@section('content')
    ...
    <div class="row justify-content-center  shadow">
        ...
        <div class="col-md-10">
            <h2 class="text-center font-weight-bold mt-4 ">Crear nuevo testimonio</h2>
            <form  method="POST" action="{{route('testimonios.store')}}" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="form-group">
                    <label for="titulo">Titulo del testomonio</label>
                    <input type="text" name="titulo" class="form-control @error('titulo') is-invalid @enderror" id="titulo" value="{{old('titulo')}}" placeholder="Titulo del testimonio">
                    @error('titulo')
                ...
                <div class="form-group">
                    <input type="submit" name="" id="" class="btn btn-secondary font-weight-bold" value="Agregar Testimonio">
                </div>
            </form>  
        </div>
