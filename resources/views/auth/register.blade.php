                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fechaN" type="date" class="form-control @error('fechaN') is-invalid @enderror" name="fechaN" value="{{ old('fechaN') }}" required autocomplete="fechaN" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sexo" type="radio" class=" @error('sexo') is-invalid @enderror" name="sexo" value="Masculino" required autocomplete="sexo">Masculino
                                <br>
                                <input id="sexo" type="radio" class=" @error('sexo') is-invalid @enderror" name="sexo" value="Femenino" required autocomplete="sexo">Femenino
